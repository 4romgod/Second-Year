...
public class ListCustomersFrame extends javax.swing.JFrame {
    ...
    public ListCustomersFrame(ClientApp cli) {
        super("Customers");
        initComponents();
        this.client = cli;
        ...
        ArrayList<Customer> cusArray = (ArrayList<Customer>) client.communicate(Constants.GET+Constants.CUSTOMERS);  //we get the list of customers from the server through a req        
    ...
    private void initComponents() {
        ...
        tableCustomers.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NAME", "SURNAME", "CELL", "ID_NUMBER", "CAN_RENT"
            }
        ));
